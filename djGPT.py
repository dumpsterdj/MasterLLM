...
# --- SECRETS CONFIGURATION (Replaced .env) ---
# Streamlit Cloud looks for secrets in .streamlit/secrets.toml (local) 
# or the "Secrets" settings in the web dashboard (cloud).
...
if "OLLAMA_API_KEY" in st.secrets:
    ...
    st.error("❌ OLLAMA_API_KEY is missing from Streamlit Secrets.")
    st.info("Please add it to your .streamlit/secrets.toml or Streamlit Cloud Settings.")
    st.stop()
